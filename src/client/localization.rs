use crate::client::translations::{PageTranslation, PageTranslations};

pub static PAGE_TRANSLATIONS: PageTranslations = PageTranslations {
    ...
    general: PageTranslation {
        en: "general",
        cs: "všeobecné",
    },
    email: PageTranslation {
        en: "email",
        cs: "email",
    },
    faq: PageTranslation {
