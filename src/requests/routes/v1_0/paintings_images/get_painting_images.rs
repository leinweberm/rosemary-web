...
use crate::{database::{connection::get_client, models::image::PaintingImage}, errors::api_error::InternalServerError, requests::dto::generic_response::{GenericResponse, Status}};
